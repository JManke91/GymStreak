...
struct ExerciseProgressChartView: View {
    ...
    init(exerciseName: String, exerciseId: UUID?, availableExercises: [ExerciseWithHistory]) {
        ...
        self._viewModel = StateObject(wrappedValue: ExerciseProgressViewModel(exerciseName: exerciseName, exerciseId: exerciseId))
    }
...
struct SessionCardView: View {
    let session: ExerciseProgressChartView.RecentSession
