...
enum PeriodRecapInstructions {
    ...
    ///   converted into. The example patterns below are copied by the model
    ...
    - headline: rephrase the "Headline fact" line as one sentence. Example patterns: "Stärkster Zuwachs: Chest Press +7,0 \(unitWord) im geschätzten 1RM.", "Keine Zuwächse in diesem Zeitraum: 4 Übungen unverändert, 1 schwächer.", "Deine Kraft ist über alle 5 Übungen stabil geblieben."
