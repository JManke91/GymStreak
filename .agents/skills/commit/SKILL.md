...
```
1. User: /commit
2. Codex: Analyzes changes
3. Codex: Shows generated message: "feat: add ePaper bookmarks feature"
4. Codex: Uses ask_user_input with two options:
...
6. Codex: "Committed successfully as abc123f"
```
