# Claude Command: iPhone Screenshots

Generate iPhone-only App Store Connect screenshots in dark mode using Fastlane.

## Instructions

Run the Fastlane `screenshots` lane from the project root directory to generate dark mode screenshots for iPhone only.
